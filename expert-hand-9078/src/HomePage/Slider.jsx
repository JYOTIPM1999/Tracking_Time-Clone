...
export default function Slider() {
  return (
    <Box maxW={"6xl"} boxShadow= "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" height={"10rem"} margin="auto">  
    <Text pb="1rem"color="#7f8488" fontSize={"18px"} textAlign="center">Companies of all shapes and sizes use TrackingTime:</Text>
    <Box >
    <Swiper
    loop={true}
    navigation={true}
